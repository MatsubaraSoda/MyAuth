    ...
    <div
      ...
      <div
        ...
        <NavigationMenu class="hidden md:flex">
          <NavigationMenuList>
            <NavigationMenuItem>
              <NavigationMenuTrigger class="cursor-pointer">Notebooks</NavigationMenuTrigger>
              <NavigationMenuContent>
                <ul class="grid min-w-48 gap-1 p-2">
                  <li class="rounded-md px-3 py-2 text-sm hover:bg-accent cursor-pointer">Mathematics</li>
                  <li class="rounded-md px-3 py-2 text-sm hover:bg-accent cursor-pointer">Physics</li>
                  <li class="rounded-md px-3 py-2 text-sm hover:bg-accent cursor-pointer">Chemistry</li>
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
          </NavigationMenuList>
